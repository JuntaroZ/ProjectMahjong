...
| 国士無双 | 13 | 国士無双形 |
| 四暗刻 | 13 | 暗刻4組。ロンで和了牌が刻子を完成させる場合は不成立。 |
| 大三元 | 13 | 三元牌3種類すべての刻子 |
| 小四喜 | 13 | 風牌3種類の刻子 + 風牌の雀頭 |
| 大四喜 | 13 | 風牌4種類すべての刻子 |
| 字一色 | 13 | 字牌のみ |
| 緑一色 | 13 | 2索、3索、4索、6索、8索、發のみ |
| 清老頭 | 13 | 老頭牌のみ |
| 九蓮宝燈 | 13 | 門前、同一色で 1112345678999 + 同色1牌 |
...
| 三色同刻 | 2 | 萬子、筒子、索子で同じ数字の刻子 |
| 一気通貫 | 門前2 / 鳴き1 | 同一色で 123、456、789 |
| 混全帯么九 | 門前2 / 鳴き1 | 全面子と雀頭に么九牌を含み、字牌と順子を含む |
| 純全帯么九 | 門前3 / 鳴き2 | 全面子と雀頭に老頭牌を含み、順子を含む |
| 二盃口 | 3 | 門前、同一順子2組が2セット |
| 小三元 | 2 | 三元牌2種類の刻子 + 三元牌の雀頭 |
| 混老頭 | 2 | 么九牌のみ |
| 混一色 | 門前3 / 鳴き2 | 1色 + 字牌 |
| 清一色 | 門前6 / 鳴き5 | 1色のみ |
...
- 四槓子は槓情報を保持するデータ構造がないため未対応です。
- 流し満貫、人和など、局進行情報が必要な役は未対応です。
- 役判定は現在実装済みの役に限定されます。
